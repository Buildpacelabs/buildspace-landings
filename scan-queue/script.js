/* ScanQueue — interactions
   IntersectionObserver reveals, count-ups, acuity-mix bars.
   All motion-safe: reduced-motion renders the final state. */
(function () {
  'use strict';
  ...
  /* ---- One-shot activators (count-ups, acuity bars) ---- */
  ...
  document.querySelectorAll('[data-count], .mini-bar').forEach(function (el) { activators.observe(el); });
