/* Notewell — interactions
   IntersectionObserver reveals, count-ups, self-drawing follow-through line,
   leak meters, follow-through ring. All motion-safe. */
(function () {
  'use strict';
  ...
  /* ---- Self-drawing follow-through line ---- */
  ...
  /* ---- One-shot activators (count, meters, ring, line) ---- */
  var activators = new IntersectionObserver(function (entries) {
    entries.forEach(function (e) {
      ...
      if (el.classList.contains('nrr-chart')) drawLine(el);
  ...
  /* ---- Hero follow-through line draws on load (above the fold) ---- */
